...
local web = true
local user = "TimLiz" -- change if you're using a fork
...
environment.oh = {
    ...
    Constants = {
        ...
        Syntax = {
            ...
            buffer = Color3.fromRGB(165, 77, 128),
...
local releaseInfo = HttpService:JSONDecode(game:HttpGetAsync("https://api.github.com/repos/" .. user .. "/Hydroxide/releases"))[1] or 123
